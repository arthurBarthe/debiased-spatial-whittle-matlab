...
%
% Returns (the number of) overlapping SQUARES composing a matrix
%
% INPUT:
%
...
%
% See also: BLOCKISOLATE, BLOCKMEAN
%
% Last modified by fjsimons-at-mit.edu, 01/04/2019
...
if nargin==3 | [nargin==5 & isempty(indo)]
  ...
  % Build index arrays, note how this meshes with PCHAVE's piece
  % ... repmat([0:(n-1)]*[side(dim)-olap(dim)],side(dim),1)
